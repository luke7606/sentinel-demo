...
async function callGroq({ apiKey, system, messages, maxTokens = 600 }) {
...
const T = {
  es: {
    appSub: "Support Intelligence · Powered by Groq",
    groqBadge: "Groq API — 100% GRATUITO",
    groqDesc: "Sin tarjeta de crédito · Sin límite de tiempo · 500k tokens/día",
    model: "llama-3.1-8b-instant (open-source)",
    keyLabel: "Tu API Key de Groq",
    keyPlaceholder: "gsk_xxxxxxxxxxxxxxxxxxxx",
    keyError: "Key inválida o sin conexión. Verificá en console.groq.com",
    connectBtn: "Conectar y entrar →",
    verifying: "Verificando...",
    howTo: "¿Cómo obtener tu key gratis?",
    step1: "Entrá a", step2: "Registrate (solo email, sin tarjeta)",
    step3: 'Ir a "API Keys" → "Create API Key"', step4: "Pegá la key acá y listo",
    keyNote: "La key nunca se guarda en ningún servidor. Solo vive en tu sesión.",
    connected: "Groq conectado — listo",
    userLabel: "Usuario", passLabel: "Contraseña",
    userPlaceholder: "admin / retailco / guest",
    loginBtn: "Ingresar →", loginError: "Usuario o contraseña incorrectos",
    demoUsers: "Usuarios demo",
    demoRows: ["Admin — acceso total", "Cliente — módulo propio", "Visitante — chat general"],
    newChat: "Nuevo chat", generalChat: "Chat General", generalSub: "Asistente general",
    docsIdx: "docs indexados", turns: "turnos",
    nav: { chat: "Chat", docs: "Docs", tickets: "Tickets", admin: "Admin" },
    inputPlaceholder: "Describí el problema técnico... (Enter para enviar)",
    escalatedMsg: "Caso escalado al equipo N2. Revisá la sección Tickets.",
    kbTitle: "Base de Conocimiento", kbSub: "Cargá documentación para que Sentinel responda con precisión",
    projLabel: "Proyecto:", tabUpload: "📎 Archivo", tabUrl: "🔗 URL", tabScript: "📝 Texto",
    dropzone: "Arrastrá archivos o hacé click", dropzoneSub: "PDF · CSV · TXT · MD · JSON · YAML · JS · SQL · Excel",
    urlPlaceholder: "https://docs.proyecto.com, Confluence, Notion, GitHub...",
    addBtn: "Agregar", addKbBtn: "Agregar a la KB",
    scriptPlaceholder: "Pegá texto, JSON, scripts, changelogs, notas técnicas...",
    docsTitle: "Documentos", noDocs: "Sin documentos aún — subí algo para empezar",
    ticketsTitle: "Tickets N2", ticketsSub: "Casos escalados para resolución manual",
    backBtn: "← Volver", convTitle: "Conversación",
    suggestBtn: "✨ Sugerir respuesta con IA", generating: "Generando...",
    closeTicket: "Cerrar ticket como resuelto",
    noTickets: "No hay tickets escalados aún — eso es una buena señal 🎉",
    openBadge: "Abierto", resolvedBadge: "Resuelto",
    adminTitle: "Administración", adminSub: "Gestioná proyectos y módulos de clientes",
    createProj: "Crear proyecto", projsTitle: "Proyectos",
    projPlaceholder: "Nombre del proyecto", createBtn: "Crear", manageBtn: "Gestionar →",
    intTitle: "Integraciones de datos", apiTitle: "API en uso",
    apiDesc: "Free tier activo · Sin cargo · Sin tarjeta",
    welcomeAdmin: "¡Bienvenido, Admin! Panel completo activo.",
    welcomeGuest: "¡Hola! Soy **Sentinel** — tu asistente de soporte técnico.\n\n¿En qué puedo ayudarte?",
    welcomeClient: (name, proj) => `¡Hola, **${name}**! Tengo acceso a la documentación de **${proj}**. ¿Cuál es el problema?`,
    chatRestarted: "Chat reiniciado. ¿En qué puedo ayudarte?",
    escalatedTkt: (id) => `⚠️ **Caso escalado al equipo N2**\n\n*Ticket: **${id}***`,
    sysGuest: "Sos Sentinel, asistente técnico. Respondé en español, claro y técnico. Máximo 3 pasos. Si no se resuelve en 3 intentos, comenzá con ESCALAR_N2 y el resumen.",
    sysClient: (name, docs) => `Sos Sentinel, soporte post-entrega para "${name}".\nREGLAS: español, técnico, máximo 3 pasos. Si persiste 3 intentos: ESCALAR_N2 + resumen.\n${docs ? `DOCS:\n${docs}` : "Sin docs. Usá conocimiento general."}`,
    agentSys: "Sos un agente técnico senior. Respondé en español, conciso y accionable.",
    agentPrompt: (summary, conv) => `Respuesta técnica para este ticket.\nPROBLEMA: ${summary}\nCONV:\n${conv}\nSolo el texto.`,
  },
  en: {
    appSub: "Support Intelligence · Powered by Groq",
    groqBadge: "Groq API — 100% FREE",
    groqDesc: "No credit card · No time limit · 500k tokens/day",
    model: "llama-3.1-8b-instant (open-source)",
    keyLabel: "Your Groq API Key",
    keyPlaceholder: "gsk_xxxxxxxxxxxxxxxxxxxx",
    keyError: "Invalid key or no connection. Check console.groq.com",
    connectBtn: "Connect and enter →",
    verifying: "Verifying...",
    howTo: "How to get your free key?",
    step1: "Go to", step2: "Sign up (email only, no card)",
    step3: 'Go to "API Keys" → "Create API Key"', step4: "Paste the key here and you're done",
    keyNote: "The key is never stored on any server. It only lives in your session.",
    connected: "Groq connected — ready",
    userLabel: "Username", passLabel: "Password",
    userPlaceholder: "admin / retailco / guest",
    loginBtn: "Sign in →", loginError: "Wrong username or password",
    demoUsers: "Demo users",
    demoRows: ["Admin — full access", "Client — own module", "Guest — general chat"],
    newChat: "New chat", generalChat: "General Chat", generalSub: "General assistant",
    docsIdx: "docs indexed", turns: "turns",
    nav: { chat: "Chat", docs: "Docs", tickets: "Tickets", admin: "Admin" },
    inputPlaceholder: "Describe the technical issue... (Enter to send)",
    escalatedMsg: "Case escalated to N2 team. Check the Tickets section.",
    kbTitle: "Knowledge Base", kbSub: "Upload project documentation so Sentinel can answer accurately",
    projLabel: "Project:", tabUpload: "📎 File", tabUrl: "🔗 URL", tabScript: "📝 Text",
    dropzone: "Drag files or click to upload", dropzoneSub: "PDF · CSV · TXT · MD · JSON · YAML · JS · SQL · Excel",
    urlPlaceholder: "https://docs.myproject.com, Confluence, Notion, GitHub...",
    addBtn: "Add", addKbBtn: "Add to KB",
    scriptPlaceholder: "Paste text, JSON, scripts, changelogs, technical notes...",
    docsTitle: "Documents", noDocs: "No documents yet — upload something to get started",
    ticketsTitle: "N2 Tickets", ticketsSub: "Escalated cases for manual resolution",
    backBtn: "← Back", convTitle: "Conversation",
    suggestBtn: "✨ Suggest AI reply", generating: "Generating...",
    closeTicket: "Close ticket as resolved",
    noTickets: "No escalated tickets yet — that's a good sign 🎉",
    openBadge: "Open", resolvedBadge: "Resolved",
    adminTitle: "Administration", adminSub: "Manage projects and client modules",
    createProj: "Create project", projsTitle: "Projects",
    projPlaceholder: "Project name", createBtn: "Create", manageBtn: "Manage →",
    intTitle: "Data integrations", apiTitle: "API in use",
    apiDesc: "Free tier active · No charge · No card",
    welcomeAdmin: "Welcome, Admin! Full panel active.",
    welcomeGuest: "Hi! I'm **Sentinel** — your technical support assistant.\n\nHow can I help you?",
    welcomeClient: (name, proj) => `Hi, **${name}**! I have access to all documentation for **${proj}**. What's the issue?`,
    chatRestarted: "Chat restarted. How can I help you?",
    escalatedTkt: (id) => `⚠️ **Case escalated to N2 team**\n\n*Ticket: **${id}***`,
    sysGuest: "You are Sentinel, a technical support assistant. Reply in English, clearly and technically. Max 3 steps per response. If not resolved in 3 attempts, start with ESCALAR_N2 and a summary.",
    sysClient: (name, docs) => `You are Sentinel, post-delivery support for "${name}".\nRULES: English, technical, max 3 steps. If persists 3 attempts: ESCALAR_N2 + summary.\n${docs ? `DOCS:\n${docs}` : "No docs loaded. Use general knowledge."}`,
    agentSys: "You are a senior technical agent. Reply in English, concise and actionable.",
    agentPrompt: (summary, conv) => `Technical reply for this ticket.\nISSUE: ${summary}\nCONV:\n${conv}\nJust the reply text.`,
  }
};

const DEMO_PROJECTS = {
  "nova-commerce": {
    id: "nova-commerce", name: "Nova Commerce Platform", client: "RetailCo S.A.", color: "#6366f1",
    docs: [{
      id: "d1", name: "Tech Stack", type: "text",
      content: `Project: Nova Commerce Platform | Client: RetailCo S.A.\nStack: Node.js, React, PostgreSQL, Redis, AWS EC2\nPAYMENTS: Stripe v3 · webhook /api/payments/webhook · STRIPE_SECRET var · 30s timeout · keys rotate 90 days\nINVENTORY: cron every 5min · Redis TTL 300s · flush: redis-cli FLUSHDB\nREPORTS: pm2 "report-worker" · storage /storage/reports (chmod 755)\nINFRA: AWS EC2 + PM2 · .env at root · monitoring: pm2 monit`,
...
const USERS = {
  ...
  guest:    { id: "guest",    name: "Visitor",      role: "guest",  password: "guest" },
};
    ...
    <div style={{ display: "flex", gap: 2, background: "#1e293b", borderRadius: 8, padding: 3 }}>
      {["es","en"].map(l => (
        <button key={l} onClick={() => setLang(l)} style={{
          ...
          fontFamily: "inherit", background: lang === l ? "#4f46e5" : "transparent",
          color: lang === l ? "white" : "#64748b", transition: "all 0.15s",
        }}>
          {l === "es" ? "🇦🇷 ES" : "🇺🇸 EN"}
        </button>
      ))}
...
export default function Sentinel() {
  ...
  const login = (e) => {
    ...
    if (u && u.password === loginForm.p) {
      ...
      setMessages([{
        role: "assistant",
        content: u.role === "guest" ? t.welcomeGuest
          : u.role === "client" ? t.welcomeClient(u.name, projects[u.projectId]?.name)
          : t.welcomeAdmin,
      }]);
  ...
  const buildSystem = useCallback(() => {
    const docs = project?.docs?.length
      ? project.docs.slice(0, 2).map(d => `=== ${d.name} ===\n${d.content.slice(0, 500)}`).join("\n\n")
      : null;
    if (!user || user.role === "guest") return t.sysGuest;
    return t.sysClient(project?.name || pid, docs);
  }, [project, user, pid, t]);
  ...
  const send = async () => {
    ...
    try {
      ...
      if (reply.startsWith("ESCALAR_N2")) {
        ...
        setMessages(p => [...p, { role: "assistant", content: t.escalatedTkt(tkt.id), escalated: true, ticketId: tkt.id }]);
        setEscalated(true);
      } else {
  ...
  const resolveTicket = (tId, resolution) => {
    setProjects(p => ({ ...p, [pid]: { ...p[pid], tickets: p[pid].tickets.map(t => t.id === tId ? { ...t, status: "resolved", resolution, resolvedAt: new Date().toISOString() } : t) } }));
    setSelectedTkt(null);
  };
  ...
  const suggestReply = async (tkt) => {
    setLoading(true);
    try {
      const conv = tkt.conversation.map(m => `${m.role === "user" ? "CLIENT" : "SENTINEL"}: ${m.content}`).join("\n");
      const r = await callGroq({ apiKey: groqKey, system: t.agentSys, messages: [{ role: "user", content: t.agentPrompt(tkt.summary, conv) }], maxTokens: 400 });
      setTicketReply(r);
  ...
  const addScript = () => {
    ...
    const doc = { id: Date.now(), name: "Text / Script", type: "text", content: scriptTxt, uploadedAt: new Date().toISOString().split("T")[0] };
    setProjects(p => ({ ...p, [pid]: { ...p[pid], docs: [...(p[pid]?.docs || []), doc] } }));
    setScriptTxt("");
  };

  const deleteDoc = (dId) => setProjects(p => ({ ...p, [pid]: { ...p[pid], docs: p[pid].docs.filter(d => d.id !== dId) } }));

  const addProject = () => {
    if (!newProjName.trim()) return;
    const id = newProjName.toLowerCase().replace(/\s+/g, "-");
    setProjects(p => ({ ...p, [id]: { id, name: newProjName, docs: [], tickets: [], client: "New client" } }));
      ...
      <div style={S.keyCard}>
        ...
        <div style={S.groqBanner}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
            <Icons.Zap /><strong style={{ color: "#fbbf24" }}>{t.groqBadge}</strong>
          </div>
          <div style={{ fontSize: 13, color: "#94a3b8", lineHeight: 1.6 }}>
            {t.groqDesc}<br/>
            {lang === "es" ? "Modelo: " : "Model: "}<code style={{ color: "#7dd3fc" }}>{t.model}</code>
          </div>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <label style={S.label}><Icons.Key /> &nbsp;{t.keyLabel}</label>
          <input style={S.input} placeholder={t.keyPlaceholder} value={keyInput} onChange={e => setKeyInput(e.target.value)} onKeyDown={e => e.key === "Enter" && testKey()} type="password" />
          {keyError && <div style={S.errMsg}>{keyError}</div>}
          <button onClick={testKey} disabled={keyTesting || !keyInput.trim()} style={S.bigBtn}>
            {keyTesting ? t.verifying : t.connectBtn}
          </button>
        </div>

        <div style={S.stepBox}>
          <div style={S.stepTitle}>{t.howTo}</div>
          {[[1, t.step1, "console.groq.com", "https://console.groq.com"], [2, t.step2], [3, t.step3], [4, t.step4]].map(([n, text, link, href]) => (
        ...
        <div style={{ fontSize: 11, color: "#475569", textAlign: "center", marginTop: 8 }}>{t.keyNote}</div>
      </div>
    </div>
  );
      ...
      <div style={{ ...S.keyCard, maxWidth: 380 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
          <div style={S.logoRow}>
            ...
            <div>
              <div style={S.logoTitle}>SENTINEL</div>
              <div style={{ fontSize: 11, color: "#10b981" }}>● {t.connected}</div>
            </div>
          </div>
          <LangToggle lang={lang} setLang={setLang} />
        </div>
        ...
        <form onSubmit={login} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div>
            <label style={S.label}>{t.userLabel}</label>
            <input style={S.input} placeholder={t.userPlaceholder} value={loginForm.u} onChange={e => setLoginForm(f => ({ ...f, u: e.target.value }))} />
          </div>
          <div>
          ...
          <button type="submit" style={S.bigBtn}>{t.loginBtn}</button>
        </form>

        <div style={S.stepBox}>
          <div style={S.stepTitle}>{t.demoUsers}</div>
          {[["#6366f1","admin","admin123"], ["#10b981","retailco","client123"], ["#8b5cf6","guest","guest"]].map(([c, u, p], i) => (
            <div key={u} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
              ...
              <span style={{ fontSize: 12, color: "#64748b" }}>{p} — {t.demoRows[i]}</span>
            </div>
          ))}
        </div>
      </div>
  ...
  // ── SCREEN: MAIN APP ────────────────────────────────
  const navItems = [
    { key: "chat", label: t.nav.chat, Icon: Icons.Bot },
    ...(user.role !== "guest" ? [{ key: "docs", label: t.nav.docs, Icon: Icons.File }] : []),
    ...(user.role !== "guest" ? [{ key: "tickets", label: t.nav.tickets, Icon: Icons.Ticket }] : []),
    ...(user.role === "admin" ? [{ key: "admin", label: t.nav.admin, Icon: Icons.Settings }] : []),
  ];
    ...
    <div style={S.app}>
      ...
      <aside style={S.sidebar}>
        <div style={S.sideLogoRow}>
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: "#10b981" }}>● Groq · llama-3.1-8b</div>
          </div>
        </div>
        ...
        <div style={{ padding: "10px 4px", borderBottom: "1px solid #1e293b", marginBottom: 10 }}>
          <LangToggle lang={lang} setLang={setLang} />
        </div>
      ...
      <main style={S.main}>
        ...
        {view === "chat" && (
          <div style={S.chatWrap}>
            <div style={S.chatHead}>
              <div>
                <div style={{ fontWeight: 700, fontSize: 15, color: "#f1f5f9" }}>{project ? project.name : t.generalChat}</div>
                <div style={{ fontSize: 11, color: "#64748b", marginTop: 2 }}>
                  {user.role === "guest" ? t.generalSub : `${project?.docs?.length || 0} ${t.docsIdx}`} · {steps} {t.turns}
                </div>
              </div>
              <button onClick={() => { setMessages([{ role: "assistant", content: t.chatRestarted }]); setSteps(0); setEscalated(false); }} style={S.smBtn}>
                {t.newChat}
              </button>
            </div>
            ...
            <div style={S.msgs}>
              {messages.map((m, i) => (
                <div key={i} style={{ display: "flex", justifyContent: m.role === "user" ? "flex-end" : "flex-start", gap: 8, alignItems: "flex-end" }}>
                  {m.role === "assistant" && <div style={{ ...S.ava, background: m.escalated ? "#7f1d1d" : "#312e81" }}>{m.escalated ? <Icons.Alert /> : <Icons.Bot />}</div>}
                  <div style={{ maxWidth: "72%", padding: "10px 14px", borderRadius: 14, fontSize: 14, lineHeight: 1.65,
                    ...(m.role === "user" ? { background: "#4f46e5", color: "white", borderBottomRightRadius: 4 } : { background: "#1e293b", color: "#e2e8f0", border: "1px solid #334155", borderBottomLeftRadius: 4 }),
                    ...(m.escalated ? { borderColor: "#dc2626" } : {}), ...(m.error ? { borderColor: "#f43f5e", color: "#fca5a5" } : {}),
                  }}>
                    <MD text={m.content} />
                    {m.ticketId && <div onClick={() => setView("tickets")} style={{ marginTop: 8, fontSize: 11, color: "#818cf8", cursor: "pointer", textDecoration: "underline" }}>🎫 {m.ticketId}</div>}
                  </div>
              ...
              {loading && (
                <div style={{ display: "flex", gap: 8, alignItems: "flex-end" }}>
                  ...
                  <div style={{ background: "#1e293b", border: "1px solid #334155", borderRadius: 14, borderBottomLeftRadius: 4, padding: "10px 14px" }}><Dots /></div>
                </div>
              )}
              <div ref={bottomRef} />
            </div>
            ...
            <div style={S.inputRow}>
              {escalated ? (
                <div style={{ flex: 1, textAlign: "center", color: "#f87171", fontSize: 13, fontWeight: 600 }}>⚠️ {t.escalatedMsg}</div>
              ) : (
                <>
                  <textarea ref={inputRef} rows={2} style={S.ta} value={input} onChange={e => setInput(e.target.value)}
                    onKeyDown={e => { if (e.key === "Enter" && !e.shiftKey) { e.preventDefault(); send(); } }}
                    placeholder={t.inputPlaceholder} />
                  <button onClick={send} disabled={loading || !input.trim()} style={S.sendBtn}><Icons.Send /></button>
                </>
              )}
            </div>
          </div>
        ...
        {view === "docs" && user.role !== "guest" && (
          <div style={S.panel}>
            <div style={{ marginBottom: 24 }}>
              <h2 style={S.panelH}>{t.kbTitle}</h2>
              <p style={S.panelSub}>{t.kbSub}</p>
            </div>

            {user.role === "admin" && (
              <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 20 }}>
                <label style={{ ...S.label, margin: 0 }}>{t.projLabel}</label>
            ...
            <div style={{ display: "flex", gap: 4, marginBottom: 16 }}>
              {[["upload", t.tabUpload], ["url", t.tabUrl], ["script", t.tabScript]].map(([k, l]) => (
                <button key={k} onClick={() => setTab(k)} style={{ ...S.tab, ...(tab === k ? S.tabActive : {}) }}>{l}</button>
              ))}
            </div>

            {tab === "upload" && (
              <div style={S.dropzone} onDragOver={e => e.preventDefault()} onDrop={e => { e.preventDefault(); uploadFiles(e.dataTransfer.files); }} onClick={() => fileRef.current?.click()}>
                <Icons.Upload />
                <div style={{ marginTop: 10, fontWeight: 600, color: "#94a3b8", fontSize: 14 }}>{t.dropzone}</div>
                <div style={{ fontSize: 12, color: "#475569", marginTop: 4 }}>{t.dropzoneSub}</div>
            ...
            {tab === "url" && (
              <div style={{ display: "flex", gap: 8, marginBottom: 20, background: "#1e293b", border: "1px solid #334155", borderRadius: 10, padding: "8px 12px", alignItems: "center" }}>
                ...
                <input style={{ ...S.input, flex: 1, margin: 0, background: "transparent", border: "none", padding: "4px 0" }}
                  placeholder={t.urlPlaceholder} value={urlInput} onChange={e => setUrlInput(e.target.value)} onKeyDown={e => e.key === "Enter" && addUrl()} />
                <button onClick={addUrl} style={S.smBtn}>{t.addBtn}</button>
              </div>
            )}

            {tab === "script" && (
              <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 20 }}>
                <textarea style={{ ...S.ta, minHeight: 140, borderRadius: 10 }} placeholder={t.scriptPlaceholder} value={scriptTxt} onChange={e => setScriptTxt(e.target.value)} />
                <button onClick={addScript} style={S.smBtn}>{t.addKbBtn}</button>
              </div>
            )}

            <div style={S.docList}>
              <div style={S.docListHdr}>{t.docsTitle} — {(project?.docs || []).length}</div>
              ...
              {!(project?.docs?.length) && <div style={{ padding: 32, textAlign: "center", color: "#475569", fontSize: 13 }}>{t.noDocs}</div>}
            </div>
          </div>
        )}
        ...
        {view === "tickets" && user.role !== "guest" && (
          <div style={S.panel}>
            <div style={{ marginBottom: 24 }}>
              <h2 style={S.panelH}>{t.ticketsTitle}</h2>
              <p style={S.panelSub}>{t.ticketsSub}</p>
            </div>

            {selectedTkt ? (
              <div>
                <button onClick={() => { setSelectedTkt(null); setTicketReply(""); }} style={S.smBtn}>{t.backBtn}</button>
                <div style={{ ...S.tktCard, cursor: "default", marginTop: 16 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                    ...
                    <span style={{ ...S.badge, background: selectedTkt.status === "open" ? "#b91c1c" : "#065f46" }}>
                      {selectedTkt.status === "open" ? t.openBadge : t.resolvedBadge}
                    </span>
                  </div>
                ...
                <div style={{ ...S.docList, marginTop: 16 }}>
                  <div style={S.docListHdr}>{t.convTitle}</div>
                  {selectedTkt.conversation?.map((m, i) => (
                    <div key={i} style={{ padding: "10px 14px", borderBottom: "1px solid #1e293b" }}>
                      <div style={{ fontSize: 11, fontWeight: 700, color: m.role === "user" ? "#818cf8" : "#34d399", textTransform: "uppercase", marginBottom: 2 }}>
                        {m.role === "user" ? (lang === "es" ? "Cliente" : "Client") : "Sentinel"}
                      </div>
                ...
                {selectedTkt.status === "open" && (
                  <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 8 }}>
                    <button onClick={() => suggestReply(selectedTkt)} disabled={loading} style={S.smBtn}>
                      {loading ? t.generating : t.suggestBtn}
                    </button>
                    {ticketReply && <textarea style={{ ...S.ta, minHeight: 100 }} value={ticketReply} onChange={e => setTicketReply(e.target.value)} />}
                    <button onClick={() => resolveTicket(selectedTkt.id, ticketReply || (lang === "es" ? "Resuelto por agente N2" : "Resolved by N2 agent"))}
                      style={{ ...S.smBtn, background: "#065f46", borderColor: "#10b981" }}>
                      <Icons.Check /> {t.closeTicket}
                    </button>
                  </div>
                )}
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                      <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                        <span style={{ ...S.badge, background: tkt.status === "open" ? "#b91c1c" : "#065f46" }}>
                          {tkt.status === "open" ? t.openBadge : t.resolvedBadge}
                        </span>
        ...
        {view === "admin" && user.role === "admin" && (
          <div style={S.panel}>
            <div style={{ marginBottom: 24 }}>
              <h2 style={S.panelH}>{t.adminTitle}</h2>
              <p style={S.panelSub}>{t.adminSub}</p>
            </div>

            <div style={S.section}>
              <div style={S.sectionTitle}>{t.createProj}</div>
              <div style={{ display: "flex", gap: 8 }}>
                <input style={{ ...S.input, flex: 1 }} placeholder={t.projPlaceholder} value={newProjName} onChange={e => setNewProjName(e.target.value)} onKeyDown={e => e.key === "Enter" && addProject()} />
                <button onClick={addProject} style={S.smBtn}><Icons.Plus /> {t.createBtn}</button>
              </div>
            </div>

            <div style={S.section}>
              <div style={S.sectionTitle}>{t.projsTitle} ({Object.keys(projects).length})</div>
              {Object.values(projects).map(p => (
                <div key={p.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", background: "#1e293b", borderRadius: 10, marginBottom: 6 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 11, color: "#475569" }}>{p.docs?.length || 0} docs · {p.tickets?.filter(t => t.status === "open")?.length || 0} open</div>
                  </div>
                  <button onClick={() => { setActive(p.id); setView("docs"); }} style={S.smBtn}>{t.manageBtn}</button>
                </div>
              ))}
            </div>

            <div style={S.section}>
              <div style={S.sectionTitle}>{t.intTitle}</div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                {[["📄","PDF","✓"],["📊","CSV / Excel","✓"],["📝",lang==="es"?"Texto / Script":"Text / Script","✓"],["🔗","URL / Web","✓"],
                  ["🎯","Jira","⏳"],["📚","Confluence","⏳"],["⚡","Notion","⏳"],["✅","ClickUp","⏳"]].map(([icon, name, status]) => (
                  <div key={name} style={{ display: "flex", gap: 10, alignItems: "center", padding: "10px 12px", background: "#1e293b", borderRadius: 8, border: "1px solid #334155" }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 11, color: status === "✓" ? "#10b981" : "#475569" }}>{status === "✓" ? (lang==="es"?"✓ Activo":"✓ Active") : (lang==="es"?"Próximamente":"Coming soon")}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div style={S.section}>
              <div style={S.sectionTitle}>{t.apiTitle}</div>
              <div style={{ padding: 14, background: "#0f2240", border: "1px solid #1d4ed8", borderRadius: 10, fontSize: 13, color: "#93c5fd" }}>
                <strong>Groq Cloud</strong> · llama-3.1-8b-instant · Free tier<br/>
                <span style={{ fontSize: 11, color: "#60a5fa" }}>{t.apiDesc}</span>
              </div>
            </div>
          </div>
        )}
...
const S = {
  ...
  logoBox:     { width: 42, height: 42, background: "linear-gradient(135deg,#4f46e5,#7c3aed)", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 20, color: "white" },
  logoTitle:   { fontWeight: 800, fontSize: 18, color: "#f1f5f9", letterSpacing: 3 },
  logoSub:     { fontSize: 11, color: "#475569", marginTop: 2 },
  groqBanner:  { background: "#1a1205", border: "1px solid #78350f", borderRadius: 10, padding: "14px 16px", marginBottom: 24, marginTop: 24 },
